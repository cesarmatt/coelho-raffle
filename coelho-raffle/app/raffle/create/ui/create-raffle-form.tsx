...
export default function CreateRaffleForm() {
    return (
            <form action={createRaffle} className="container mx-auto bg-gray-light rounded-lg px-4 mt-1.5 py-1.5">
                ...
                <div className="mb-1.5">
                  <label htmlFor="hs-input-with-leading-and-trailing-icon" className="block text-sm font-medium mb-2 dark:text-black">Valor do número</label>
                  <div className="relative">
                    <input type="number" id=" value" name="value" step="0.01" className="py-3 px-4 ps-9 pe-16 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-black dark:focus:ring-gray-600" placeholder="0.00" />
